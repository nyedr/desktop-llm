...
describe("Path Utilities", () => {
    describe("validatePath", () => {
        ...
        it("should reject symlinks pointing outside allowed directories", async () => {
            ...
            await expect(validatePath(symlink, [testDir])).rejects.toThrow(/Access denied - symlink target outside allowed directories/);
        ...
        it("should reject new files in unauthorized directories", async () => {
            ...
            await expect(validatePath(newFile, [testDir])).rejects.toThrow(/Access denied - path outside allowed directories/);
